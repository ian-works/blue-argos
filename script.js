...
(function () {
  ...
  var I18N = {
    ko: {
      ...
      "nav.ring": "블루 링",
      "nav.releases": "릴리즈",
      "hero.eyebrow": "개인정보 없음 · 광고 없음 · 통신·배터리 최소화",
      ...
      "hero.badge2": "현재 개발 중",
      "promise.h2": "지켜보되, 캐묻지 않습니다",
      "promise.p": "이름의 뜻 그대로 — 그리스 신화 속 눈이 백 개 달린 감시자 아르고스(Argos)처럼 늘 지켜보지만, 정작 사용자에 대해서는 아무것도 묻지 않습니다.",
      "card1.h3": "개인정보 입력 없음",
      "card1.li1": "<strong>회원가입, 차량 정보 필요 없음</strong> — App을 설치하고 바로 사용하면 됩니다. Android의 루틴, iOS의 자동화 기능을 사용하면 차량 탑승시 자동실행 하차시 자동 종료됩니다.",
      "card1.li2": "<strong>목적지 입력 없음</strong> — 어디로 가는지 몰라도 됩니다. 경로를 넣지 않아도 주변 카메라를 그때그때 알려줍니다.",
      "card2.h3": "통신 최소화",
      "card2.p": "카메라 위치는 미리 내려받아 기기에 저장한 정적 데이터로 판단합니다. 실시간으로 서버에 묻지 않아도 항상 동작하고, 갱신될 때마다 받는 양도 약 3MB 수준 — 지도를 계속 스트리밍하는 일반 내비게이션 데이터 사용량의 100분의 1 정도밖에 안 됩니다.",
      "card3.h3": "배터리 최소화",
      "card3.p": "저속 구간에서는 위치 확인 주기를 늘리고, 실제로 필요한 순간에만 정밀 추적으로 전환합니다.",
      "card4.h3": "광고 없음",
      "card4.p": "배너도, 팝업도, 리워드 영상도 없습니다. 광고 대신 한 번만 저렴하게 구매하면 끝 — 평생 자동으로 업데이트됩니다.",
      "how.h2": "동작 방식",
    ...
    en: {
      ...
      "hero.eyebrow": "No personal data · No ads · Minimal data & battery use",
      ...
      "promise.h2": "Watching, without asking questions",
      "promise.p": "True to its name — like Argos, the hundred-eyed watcher of Greek myth, it keeps watch at all times, yet asks nothing about you.",
      "card1.h3": "No personal data required",
      "card1.li1": "<strong>No sign-up, no vehicle info</strong> — install the app and start using it right away. Pair it with Android Routines or iOS Automations to launch when you get in the car and quit when you get out.",
      "card1.li2": "<strong>No destination required</strong> — it doesn't need to know where you're going. Without a route, it still tells you about nearby cameras as you drive.",
      "card2.h3": "Minimal data use",
      "card2.p": "Camera locations are judged from static data downloaded ahead of time and stored on your device. It always works without asking a server in real time, and each update is only about 3MB — roughly a hundredth of what a typical navigation app uses streaming maps continuously.",
      "card3.h3": "Minimal battery use",
      "card3.p": "At low speeds it checks your location less often, switching to precise tracking only when it's actually needed.",
      "card4.h3": "No ads",
      "card4.p": "No banners, no pop-ups, no reward videos. Instead of ads, a single low-cost purchase — updated automatically for life.",
      "how.h2": "How it works",
