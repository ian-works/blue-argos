...
(function () {
  ...
  var I18N = {
    ko: {
      ...
      "card3.h3": "통신 최소화",
      "card3.p": "카메라 위치는 미리 내려받아 기기에 저장한 정적 데이터로 판단합니다. 실시간으로 서버에 묻지 않아도 항상 동작하고, 갱신될 때마다 받는 양도 약 3MB 수준 — 지도를 계속 스트리밍하는 일반 내비게이션 데이터 사용량의 100분의 1 정도밖에 안 됩니다.",
      "card4.h3": "배터리 최소화",
      "card4.p": "저속 구간에서는 위치 확인 주기를 늘리고, 실제로 필요한 순간에만 정밀 추적으로 전환합니다.",
      "card5.h3": "광고 없음",
      "card5.p": "배너도, 팝업도, 리워드 영상도 없습니다. 광고 대신 한 번만 저렴하게 구매하면 끝 — 평생 자동으로 업데이트됩니다.",
      "how.h2": "동작 방식",
    ...
    en: {
      ...
      "card3.h3": "Minimal data use",
      "card3.p": "Camera locations are judged from static data downloaded ahead of time and stored on your device. It always works without asking a server in real time, and each update is only about 3MB — roughly a hundredth of what a typical navigation app uses streaming maps continuously.",
      "card4.h3": "Minimal battery use",
      "card4.p": "At low speeds it checks your location less often, switching to precise tracking only when it's actually needed.",
      "card5.h3": "No ads",
      "card5.p": "No banners, no pop-ups, no reward videos. Instead of ads, a single low-cost purchase — updated automatically for life.",
      "how.h2": "How it works",
