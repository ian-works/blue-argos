...
(function () {
  ...
  var I18N = {
    ko: {
      ...
      "step1.h3": "사전 경고",
      "step1.p": "현재 속도를 기준으로 과속 카메라까지 남은 시간을 계산해서 사용자가 설정한 시간 전에 알려줍니다. 저속이든 고속이든 미리 알려주는 시간이 동일합니다.",
    ...
    en: {
      ...
      "step1.p": "It calculates the remaining time to a speed camera based on your current speed, and alerts you before the time you've set. Whether you're going slow or fast, the lead time it gives you stays the same.",
